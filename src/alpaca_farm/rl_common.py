...
class TrainingArguments(transformers.TrainingArguments):
    ...
    algorithm: Literal["ppo"] = field(default="ppo")
    ...
    rollout_per_device_batch_size: int = field(default=4)  # Tends to be larger, since this is just decoding.
    ...
    def __post_init__(self):
        ...
        # TODO(lxuechen): Isolate tokenizer creation.
